...
export const ENROLLMENT_FIELD_TYPES = [
  ...
  { value: 'state', label: 'State (dropdown)' },
  { value: 'city', label: 'City (dropdown)' },
  ...
  steps: [
    {
      ...
      fields: [
        { id: 'f-fullName', key: 'fullName', label: 'Student Full Name', type: 'text', required: true, placeholder: 'Enter student full name', width: 'full', validation: { preset: 'name', minLength: 2, maxLength: 100 } },
        { id: 'f-dob', key: 'dateOfBirth', label: 'Date of Birth', type: 'date', required: true, width: 'half', validation: { minAge: 2, maxAge: 25 } },
        ...
        { id: 'f-aadhaar', key: 'aadhaar', label: 'Aadhaar / ID Number', type: 'text', placeholder: 'Optional', width: 'full', validation: { preset: 'aadhaar' } },
      ],
    },
    {
      id: 'step-parent',
      ...
      fields: [
        { id: 'f-fatherName', key: 'fatherName', label: 'Father Name', type: 'text', required: true, width: 'full', validation: { preset: 'name' } },
        { id: 'f-fatherMobile', key: 'fatherMobile', label: 'Father Mobile', type: 'tel', required: true, width: 'full', validation: { preset: 'mobile_in' } },
        { id: 'f-fatherEmail', key: 'fatherEmail', label: 'Father Email', type: 'email', width: 'full', validation: { preset: 'email' } },
        { id: 'f-fatherOcc', key: 'fatherOccupation', label: 'Father Occupation', type: 'text', width: 'full' },
        { id: 'f-motherName', key: 'motherName', label: 'Mother Name', type: 'text', required: true, width: 'full', validation: { preset: 'name' } },
        { id: 'f-motherMobile', key: 'motherMobile', label: 'Mother Mobile', type: 'tel', width: 'full', validation: { preset: 'mobile_in' } },
        { id: 'f-motherEmail', key: 'motherEmail', label: 'Mother Email', type: 'email', width: 'full', validation: { preset: 'email' } },
        ...
        { id: 'f-altContact', key: 'alternateContact', label: 'Alternate Contact', type: 'tel', wideLabel: true, width: 'full', validation: { preset: 'mobile_in' } },
      ],
    },
    {
      id: 'step-address',
      ...
      stepType: 'form',
      sectionKey: 'address',
      notes: 'Current and permanent address must be complete with country, state, city, and PIN / ZIP code.',
      fields: [
        { id: 'f-currAddr', key: 'currentAddress', label: 'Current Address', type: 'textarea', required: true, stacked: true, width: 'full', validation: { minLength: 10, maxLength: 300 } },
        ...
        { id: 'f-country', key: 'country', label: 'Country', type: 'country', required: true, defaultValue: 'India', defaultCountryCode: 'IN', width: 'half' },
        { id: 'f-state', key: 'state', label: 'State', type: 'state', required: true, width: 'half' },
        { id: 'f-city', key: 'city', label: 'City', type: 'city', required: true, width: 'half' },
        { id: 'f-pin', key: 'pinCode', label: 'PIN / ZIP Code', type: 'text', required: true, width: 'half', validation: { preset: 'pincode_in' } },
      ],
    },
    {
      id: 'step-academic',
    ...
    },
    {
      ...
      fields: [
        ...
        { id: 'f-emergNo', key: 'emergencyContactNumber', label: 'Emergency Contact No.', type: 'tel', wideLabel: true, width: 'full', validation: { preset: 'mobile_in' } },
      ],
    },
    {
      id: 'step-documents',
      ...
      fields: [
        { id: 'd-birth', key: 'birthCertificate', label: 'Birth Certificate', type: 'file', required: true, fileCategory: 'document', width: 'full', wideLabel: true, validation: { maxSizeMB: 5 } },
        { id: 'd-photo', key: 'studentPhoto', label: 'Student Photo', type: 'file', required: true, fileCategory: 'photo', width: 'full', wideLabel: true, validation: { maxSizeMB: 2 } },
        { id: 'd-parentId', key: 'parentIdProof', label: 'Parent ID Proof', type: 'file', required: true, fileCategory: 'document', width: 'full', wideLabel: true, validation: { maxSizeMB: 5 } },
        { id: 'd-address', key: 'addressProof', label: 'Address Proof', type: 'file', fileCategory: 'document', width: 'full', wideLabel: true, validation: { maxSizeMB: 5 } },
        { id: 'd-report', key: 'reportCard', label: 'Previous Report Card', type: 'file', fileCategory: 'document', width: 'full', wideLabel: true, validation: { maxSizeMB: 5 } },
        { id: 'd-tc', key: 'transferCertificate', label: 'Transfer Certificate', type: 'file', fileCategory: 'document', width: 'full', wideLabel: true, validation: { maxSizeMB: 5 } },
      ],
    },
    {
      id: 'step-declaration',
