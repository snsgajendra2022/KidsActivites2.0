...
export function VerticalScrollTimeline({ steps, renderContent }) {
  ...
  return (
    <div ref={containerRef} className="relative w-full py-10">
      ...
      <div className="absolute top-10 bottom-10 left-[29px] w-[2px] bg-gray-200 md:left-[39px]" />

      {/* Foreground Progress Line (Active) */}
      <motion.div
        className="absolute top-10 bottom-10 left-[29px] w-[2px] origin-top bg-brand md:left-[39px]"
        style={{ scaleY }}
      />
...
function TimelineStep({ step, index, children }) {
  ...
  return (
    <div ref={stepRef} className="relative flex flex-col md:flex-row gap-6 md:gap-10">
      {/* Step Indicator Circle */}
      <div className="relative z-10 flex w-full md:w-[80px] shrink-0 justify-start md:justify-center">
        <div
